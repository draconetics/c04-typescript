    ...
    describe("GET /api/user", ()=>{
        ...
        describe("Database User table is empty",()=>{
            ...
            describe("Inserting 1 User object", ()=>{
                ...
                before( function (done) {
                    User.create({name:"pedro",email:"pedro@gmail.com",password:"pedro"}, function (err:object) {
                    if (err) done(err);
                    done();
                    });
                })
            ...
            describe("User table has one element",()=>{
                ...
                before( function (done) {
                    ...
                    User.create({name:"juan", email:"juan@gmail.com", password:"juan"}, function (err:object, res:any) {
                    if (err) done(err);
                        ID_NOTE = res._id;
                        //console.log("+++++++++++++++++++++++++",ID_NOTE)
                        done();
